import 'package:kisiler/VeriTabanYardimcisi.dart';
...
class Kisilerdao {
  Future<List<Kisilerdb>> tumKisiler() async {
    ...
    return List.generate(listem.length, (index) {
      ...
      return Kisilerdb(kisi_id, kisi_ad, kisi_tel,ders_hoca,ders_tarih);
    });
  }
  ...
  Future<void> kisi_kayit_et(String ders_ad, String ders_akts ,String ders_hoca,String ders_tarih) async {
    var db = await VeriTabaniYardimcisi.connectToDatabase();
